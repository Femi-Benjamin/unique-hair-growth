        ...
        <div className="max-w-4xl mx-auto">
            ...
            <Card className="bg-gradient-card border-primary/50 hover:shadow-glow transition-smooth">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Visit our salon for a comprehensive hair assessment and treatment
                </p>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button 
                variant="outline"
                onClick={() => window.open('https://wa.me/27814437-4707?text=Hi, I would like to book a consultation', '_blank')}
              >
