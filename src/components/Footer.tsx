      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Premium organic hair treatment solutions crafted from nature's finest ingredients.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2 text-muted-foreground">
                ...
                <div>
                  <a href="tel:0814437-4707" className="hover:text-primary transition-smooth">
                    0814 437 4707
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-2 text-muted-foreground">
                ...
                <a href="mailto:info@dheesorganic.co.za" className="hover:text-primary transition-smooth">
            ...
            <div className="mt-4">
              ...
              <p className="text-sm text-foreground">Mon - Sat: 9:00 - 18:00</p>
              <p className="text-sm text-foreground">Sun: 10:00 - 16:00</p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Subscribe for exclusive offers and hair care tips. Get 10% off your first order!
            </p>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          ...
          <div className="flex gap-6">
            ...
            <a href="#" className="hover:text-primary transition-smooth">Shipping & Returns</a>
          </div>
        </div>
      </div>
    </footer>
